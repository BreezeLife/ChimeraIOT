...
send_message('/configure', {
	"credentials": {
				"app_id": "NMDPTRIAL_zhaoweiqi_gmail_com20160716072249",
				"app_key": "8cf01534a2d19b34a97b459388104ca3348752640755d4ff576958eda58f37317f4d66221e0156c77d9b5a05aca7a8e02efa4436501835a7818d94261ccc589c"
			},
			"wakeup": {
				"phrases": [
					'hey Max',
...
while True:
	...
	if message['event'] == 'recognition_state':
		...
		if intent == 'GOOD_NIGHT':
			urlopen('http://10.10.61.181:8080/itv/startURL?url=http://fierce-coast-91723.herokuapp.com/leave')
		if intent is not None:
			send_message('/output/synthesize', {'text': 'got it.'})
			if intent == 'NO_MATCH':
